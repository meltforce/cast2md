...
SCHEMA_STATEMENTS = [
    ...
    """,
    # Transcript segments table for FTS (replaces SQLite FTS5)
    """
    ...
    # Episode FTS table (replaces SQLite FTS5)
    """
    ...
    # Vector embeddings table (replaces sqlite-vec)
    """
...
def get_postgres_schema() -> list[str]:
